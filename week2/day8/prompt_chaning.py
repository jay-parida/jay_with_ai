...
def step3_match(candidate,jd):
    ...
    1 and 100. also produce a short verdict whther the candidate is a good fit for the role, dont need to mention how you calculating the matching ,directly give the final score and  if the skills are matching 50% or more then you should say the candidate is a good fit for the role otherwise you should say the candidate is not a good fit for the role.
    """
    user_prompt=f"""
